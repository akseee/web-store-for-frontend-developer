...
Он имеет следующеие защищенные поля HTML-элементов: обертка страницы, отображение каталога с карточками, отображения корзины и количества товаров в нем. Добавляет слушатель при нажатии на иконку корзины.
**Свойства**:
...
Иницпиализирует поля формы с почтой и телефоном
Свойства:
